...
swift sft \
    ...
    --dataset '/BDSZ6/private/user/yxd/data/qwen/agent_phase3_4/agent_train.jsonl'\
                '/BDSZ6/private/user/yxd/data/qwen/agent_phase3_4/agent_val.jsonl' \
    --val_dataset '/BDSZ6/private/user/yxd/data/qwen/agent_phase3_4/agent_val.jsonl' \
    ...
    --logging_steps 10 \
    --max_length 16384 \
    --output_dir '/BDSZ6/private/user/yxd/dtos_output/qwen/agent_phase3_4' \
    --warmup_ratio 0.1 \
    --deepspeed zero2 \
    --dataset_num_proc 4 \
